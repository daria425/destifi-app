...
@router.post('/create')
async def create_itinerary(uid:str, image_file:UploadFile=File(...),user_db_service:UserDatabaseService=Depends(), travel_image_analyzer:TravelImageAnalyzer=Depends()):
    ...
    if uploaded_image_urls:
        ...
        ai_itinerary=create_itinerary_from_image(travel_image_analyzer=travel_image_analyzer, image_data_url=uploaded_image_urls["sas_url"])
        return {
